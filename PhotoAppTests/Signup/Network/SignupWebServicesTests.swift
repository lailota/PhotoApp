...
class SignupWebServicesTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        signFormRequestModel = SignupFormRequestModel(firstName: "Laila", lastName: "Hussein", email: "test@test.com", password: "123456789")
    }
    ...
    func testSignupWebService_WhenReceiveDifferentJSONResponse_ErrorTookPlace() {
        ...
        let expectation = self.expectation(description: "Signup() method expectation for a response that constains a different JSON structure")
        // Act
        sut.signup(withForm: signFormRequestModel) { (signupResponseModel, error) in
